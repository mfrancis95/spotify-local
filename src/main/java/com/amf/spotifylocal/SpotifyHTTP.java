...
public class SpotifyHTTP implements Spotify<JSONObject> {
    ...
    public SpotifyHTTP() throws IOException {
        this("localhost");
    }
    
    public SpotifyHTTP(String host) throws IOException {
    ...
    public SpotifyHTTP(String host, int portStart, int portEnd) throws IOException {
